      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-12 text-neutral-600 leading-relaxed">
          <section>
            ...
            <p>
              Welcome to Developer Studios. We respect your privacy and are committed to protecting your personal data. 
          ...
          <section>
            <h2 className="text-xl font-bold text-neutral-900 mb-4">2. The Data We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-neutral-900 mb-4">3. How We Use Your Data</h2>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:hello@developerstudios.in" className="text-red-600 hover:underline ml-1">hello@developerstudios.in</a>
            </p>
          </section>
        </div>
      </div>
